...
@section('content')
    ...
    <div class="mx-auto max-w-5xl px-4 py-8">
        <div class="exam-simulator flex flex-col space-y-5"
            ...
            <div class="space-y-4">
                <div class="rounded-md border border-secondary-container smooth clr-text-primary bg-inner-container pt-10 h-full">
                        ...
                        <div class="mx-4 rounded-2xl overflow-hidden smooth clr-text-primary bg-primary-container relative z-30">
                            ...
                            <div class="flex-center-both">
                                <div class="w-full max-w-2xl bg-third-container rounded-md px-5 py-2 shadow-md space-y-3 smooth clr-text-primary">
                                    ...
                                    {{-- عرض الإجابات (بتظهر بعد التسليم) --}}
                                    <div class="flex-center-both mb-4">
                                        <button type="button" @click="showAnswers()"
                                                class="border-2 smooth w-full max-w-xs bg-primary-500 border-primary-500 dark:bg-primary-600 dark:border-primary-600 hover:bg-transparent dark:hover:bg-transparent hover:text-primary-500 dark:hover:text-primary-600 text-white rounded-md px-4 py-2">عرض الإجابات</button>
                                    </div>
