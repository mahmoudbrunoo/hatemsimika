{{-- ============================================================================
     ...
     صفحة مستقلة: تحمل target.css المنسوخ كما هو + overrides.css + homepage.js
        ...
        <div class="relative h-full rounded-[inherit]">
            <div class="max-w mx-auto px-2 sm:px-2 lg:px-4 h-full">
                ...
                <div class="relative flex items-center justify-between h-full flex-row-reverse">
                    {{-- مفتاح الوضع الليلي (موبايل) --}}
                    <div class="en block md:hidden absolute left-0">
                        <button data-theme-switch class="relative inline-flex items-center py-1.5 px-2 rounded-full transition-colors duration-300 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white focus:outline-none bg-slate-700 text-slate-400 focus-visible:ring-slate-500" role="switch" type="button" tabindex="0" aria-checked="false">
                            <span class="sr-only">تبديل الوضع الليلي</span>
                            <svg data-track-sun width="24" height="24" fill="none" class="transform transition-transform scale-0 duration-300"><path d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 4v1M18 6l-1 1M20 12h-1M18 18l-1-1M12 19v1M7 17l-1 1M5 12H4M7 7 6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            <svg data-track-moon width="24" height="24" fill="none" class="ml-3.5 transform transition-transform scale-100 duration-500"><path d="M18 15.63c-.977.52-1.945.481-3.13.481A6.981 6.981 0 0 1 7.89 9.13c0-1.185-.04-2.153.481-3.13C6.166 7.174 5 9.347 5 12.018A6.981 6.981 0 0 0 11.982 19c2.67 0 4.844-1.166 6.018-3.37ZM16 5c0 2.08-.96 4-3 4 2.04 0 3 .92 3 3 0-2.08.96-3 3-3-2.04 0-3-1.92-3-4Z" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            <span data-knob class="absolute top-0.5 left-0.5 bg-white w-8 h-8 rounded-full flex items-center justify-center transition duration-500 transform">
                                <svg data-knob-sun width="24" height="24" fill="none" class="flex-none transition duration-500 transform text-yellow-500 opacity-100 scale-100"><path d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 4v1M18 6l-1 1M20 12h-1M18 18l-1-1M12 19v1M7 17l-1 1M5 12H4M7 7 6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                                <svg data-knob-moon width="24" height="24" fill="none" class="flex-none -ml-6 transition duration-500 transform text-slate-700 opacity-0 scale-0"><path d="M18 15.63c-.977.52-1.945.481-3.13.481A6.981 6.981 0 0 1 7.89 9.13c0-1.185-.04-2.153.481-3.13C6.166 7.174 5 9.347 5 12.018A6.981 6.981 0 0 0 11.982 19c2.67 0 4.844-1.166 6.018-3.37ZM16 5c0 2.08-.96 4-3 4 2.04 0 3 .92 3 3 0-2.08.96-3 3-3-2.04 0-3-1.92-3-4Z" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            </span>
                        </button>
                    </div>
                            ...
                            <div data-menu-root class="hover:clr-text-secondary relative ar">
                                ...
                                <div data-menu-panel class="hidden absolute left-0 mt-2 rounded-md bg-inner-container clr-text-primary smooth shadow-md border-2 border-third-container overflow-hidden z-50 font-taj">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button class="block w-full px-4 py-3 smooth text-red-500 hover:bg-slate-200 dark:hover:bg-slate-800">تسجيل الخروج</button>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="hidden lg:flex relative shrink-0 sidenav-outer">
                        @foreach (['fixed', 'spacer'] as $copy)
                            <div @if ($copy === 'spacer') inert aria-hidden="true" @endif
                                 class="{{ $copy === 'fixed'
                                    ? 'smooth fixed z-30 right-0 peer navbar-complement-height pisitive-nav-top overflow-auto font-taj bg-primary-container border-l-2 border-slate-200 dark:border-slate-800 shadow-md SideNav text-primary-500 px-5'
                                    : 'smooth relative pisitive-nav-top z-0 opacity-0 peer navbar-complement-height overflow-auto font-taj bg-primary-container border-l-2 border-slate-200 dark:border-slate-800 shadow-md SideNav text-primary-500 px-5 sidenav-spacer' }}">
