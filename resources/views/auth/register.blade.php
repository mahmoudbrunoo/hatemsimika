                ...
                <div class="sm:col-span-2">
                    ...
                    @if (setting('auth.video_url'))
                        <a href="{{ setting('auth.video_url') }}" target="_blank" rel="noopener"
                           class="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border-2 border-rose-500 py-3 text-base font-bold text-rose-500 transition hover:bg-rose-500 hover:text-white dark:text-rose-400 dark:hover:bg-rose-500 dark:hover:text-white">
